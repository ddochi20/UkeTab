...
- **MP3/M4A/WAV 음원** → 기기 안에서 basic-pitch(TFLite)로 멜로디 자동 채보 → 타브 변환 (서버 불필요)
...
## 서버 없이 쓰기 (갤럭시 탭 단독)
MusicXML 변환과 MP3 채보는 기기 안에서 처리됩니다. 악보 사진은 PlayScore 2 등
악보 스캔 앱으로 MusicXML을 내보낸 뒤 "파일 열기"로 여세요.
